...
mail($myMail,$subject,$messag2,$headers);
...
Notifying the user to fill the coreect form  -->
<?php
if(isset( $_POST['name']))
$name = $_POST['name'];
...
$if ($fristname === ''){
    ...
    $content="From: $name \nEmail: $email \nMessage: $message  \nheaders: $headers";
    $recipient = "4deesproperties@gmail.com";
    $mailheader = "From: $email \r\n";
    mail($recipient, $subject, $content, $mailheader) or die("Error!");
    echo "Email sent!";
    section("Location:Registration.html?mail.php");
